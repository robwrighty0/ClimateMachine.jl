...
function source(s::ConvectiveBLGeostrophic{Momentum}, m, state, aux, t, ts, direction, diffusive)
...
function source(s::ConvectiveBLSponge{Momentum}, m, state, aux, t, ts, direction, diffusive)
