...
function config_diagnostics(driver_config)
    ...
    turb_dgngrp = setup_atmos_turbulence_stats(
        AtmosLESConfigType(),
        interval,
        driver_config.name,
        FT(100),
    ...
    pert_dgngrp = setup_atmos_default_perturbations(
        AtmosLESConfigType(),
        interval,
        driver_config.name,
        interpol = interpol,
...
function main()
    ...
    t0 = FT(0)
    timeend = FT(14400)
    Cmax = FT(0.5)     # use this for single-rate explicit LSRK144
