...
function source(s::StableBLGeostrophic{Momentum}, m, state, aux, t, ts, direction, diffusive)
...
function source(s::StableBLSponge{Momentum}, m, state, aux, t, ts, direction, diffusive)
