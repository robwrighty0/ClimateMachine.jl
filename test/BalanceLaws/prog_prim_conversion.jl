...
using ClimateMachine.Atmos: DryModel, EquilMoist, NonEquilMoist
...
@testset "Prognostic-Primitive conversion (dry)" begin
    ...
    for nt in PhaseDryProfiles(param_set, ArrayType)
        ...
        prim_arr .= 0
        prognostic_to_primitive!(prim, prog, bl, bl.moisture, e_int)
        primitive_to_prognostic!(prog, prim, bl, bl.moisture, e_pot)
