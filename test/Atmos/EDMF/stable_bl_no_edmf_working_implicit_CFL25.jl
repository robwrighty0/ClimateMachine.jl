...
function calculate_dt(dg, model::BalanceLaw, Q, Courant_number, t, direction)
    Δt = one(eltype(Q))
...
rhs_prehook_filters(bl::AtmosAcousticGravityLinearModel) = nothing
...
function main(::Type{FT}) where {FT}
    ...
    cb_print_step = GenericCallbacks.EveryXSimulationSteps(1000) do
